...
public class Corolla extends Toyota {
    ...
    public static void main(String[] args) {
        ...
        constructor ın oldugu class özelliklerini tasir
        ancak data turu parent class secildigi için
        variable lar data turunun secildiği class ve
        onun parent class larından deger alabilir

        method lar icin ise yine data turunun oldugu class a gideriz
        ancak direk method u calistirmadan önce
