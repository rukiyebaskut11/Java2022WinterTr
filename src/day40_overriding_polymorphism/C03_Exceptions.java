...
public class C03_Exceptions{
    ...
    public static void main(String[] args) {
        ...
        /*
       sayi2 0 oldugunda sayi1/0  tanımsız olacagından
       java bu durumla karsılasınca exception verir

       javanın yazdıgı mesajda exception ne tur bir sorun oldugu
       neden kaynaklandıgı
       ve hangi satirda olustugu yazar


        Exception in thread "main" java.lang.ArithmeticException: / by zero
	at day40_overriding_polymorphism.C03_Exepcitions.main(C03_Exepcitions.java:21)
