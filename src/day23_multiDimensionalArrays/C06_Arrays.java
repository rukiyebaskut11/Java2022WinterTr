...
public class C06_Arrays {
    public static void main(String[] args) {
        ...
        arr=arrayeElemanEkle(arr,5); //son durumuna bu şekilde de ekleme yapabiliriz

        System.out.println(Arrays.toString(arr));  //önceki örnek[3, 5, 7, 4]    son örnek  [3, 5, 7, 5, 2, 1]
